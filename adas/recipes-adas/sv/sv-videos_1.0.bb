...
DROPBOX_FOLDERNAME = "d2tbmbaddgt6hkl"
DROPBOX_FILENAME = "AAC4zoArsTKxzFMcNCoG5WX2a?dl=1"

SRC_URI = "https://www.dropbox.com/sh/${DROPBOX_FOLDERNAME}/${DROPBOX_FILENAME};name=tarball"
